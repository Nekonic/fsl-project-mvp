...
> **ARCHIVED — historical record, not a to-do list.**
> This plan was executed in full and produced v1.0. It is kept because the
> reasoning behind each task is occasionally useful. Do not work from it.
> Current work lives in `docs/STATE.md`; hard-won facts live in
> `docs/DECISIONS.md`. Parts of this plan were superseded during execution —
> see DECISIONS for what actually turned out to be true.
